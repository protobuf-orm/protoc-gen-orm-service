...
func TestField(t *testing.T) {
	...
	t.Run("XxxAdd", func(t *testing.T) {
		d := apptest.File_apptest_field_svc_g_proto.Messages().ByName("FieldAddRequest")
		require.NotNil(t, d)
	...
	t.Run("XxxPatch", func(t *testing.T) {
		d := apptest.File_apptest_field_svc_g_proto.Messages().ByName("FieldPatchRequest")
		require.NotNil(t, d)
